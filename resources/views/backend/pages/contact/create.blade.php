        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><i class="fa fa-plus">&ensp;</i>Add Contact</h2>
                                ...
                                <div class="col-md-12">
                                    <form action="{{route('admin-contact.store')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="location" id="location" class="form-control {{old('location')}}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="telephone" id="telephone" class="form-control {{old('telephone')}}">
                                        </div>
                                        <div class="form-group">
                                            <label for="mobile">Mobile No.
                                                <a style="color: red;">{{$errors->first('mobile')}}</a>
                                            </label><br>
                                            <input type="text" name="mobile" id="mobile" class="form-control {{old('mobile')}}">
                                        </div>
                                        <div class="form-group">
