        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><i class="fa fa-eye">&ensp;</i>Show Logo</h2>
                                        ...
                                        @foreach($logoData as $key=>$logo)
                                            <tr>
                                                ...
                                                <form action="{{route('admin-logo.destroy',$logo->id)}}"method="post">
                                                    {{csrf_field()}}
                                                    @method('delete')
                                                        <a href="{{route('admin-logo.edit',$logo->id)}}" class="btn-sm btn-primary" ><i class="fa fa-edit"></i></a>
