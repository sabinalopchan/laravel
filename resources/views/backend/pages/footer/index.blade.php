        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><i class="fa fa-eye">&ensp;</i>Show Terms & Conditions</h2>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        @foreach($footerData as $key=>$footer)
                                            <tr>
                                                <td>{{++$key}}</td>
                                                <td>
                                                    <img src="{{url('uploads/footer/'.$footer->image)}}"
                                                         width="40" alt="">
                                                </td>
                                                ...
                                                <td>
                                                    <form action="{{route('admin-footer.destroy',$footer->id)}}"method="post">
                                                        {{csrf_field()}}
                                                        @method('delete')
                                                        <a href="{{route('admin-footer.edit',$footer->id)}}" class="btn-sm btn-primary" ><i class="fa fa-edit"></i></a>
