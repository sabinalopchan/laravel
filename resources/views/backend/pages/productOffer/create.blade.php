        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><i class="fa fa-plus">&ensp;&ensp;</i>Add Product On Offer</h2>
                        ...
                        <div class="x_content">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <form action="{{route('admin-product-offer.store')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="status">Price
                                                        <a style="color: red;">{{$errors->first('price')}}</a>
                                                    </label>
                                                    <input type="text" name="price" id="price" class="form-control" {{old('price')}} >
